...
type UITranslations struct {
	...
	AuthRequiredTitle       string `yaml:"auth_required_title" json:"auth_required_title"`
	AuthRequiredDesc        string `yaml:"auth_required_desc" json:"auth_required_desc"`
	AuthPassword            string `yaml:"auth_password" json:"auth_password"`
	AuthPasswordPlaceholder string `yaml:"auth_password_placeholder" json:"auth_password_placeholder"`
	AuthSignIn              string `yaml:"auth_sign_in" json:"auth_sign_in"`
	AuthSigningIn           string `yaml:"auth_signing_in" json:"auth_signing_in"`
	AuthLoginFailed         string `yaml:"auth_login_failed" json:"auth_login_failed"`
